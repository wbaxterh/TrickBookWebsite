...
const API_URL = "http://174.129.64.158:9000/api/blog";
const API_IMAGE_UPLOAD_URL = "http://174.129.64.158:9000/api/blogImage/upload";
...
export async function uploadImage(file, blogUrl, token) {
	console.log("blogURL PARAM == ", blogUrl);
