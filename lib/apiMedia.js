...
export async function getCouchVideos({ sport, collection, type, sort, limit, page } = {}) {
...
export const COUCH_SORT_OPTIONS = [
  { value: 'releaseYear', label: 'Newest Release' },
  { value: 'popular', label: 'Most Watched' },
  { value: 'rating', label: 'Top Rated' },
  { value: 'createdAt', label: 'Recently Added' },
  { value: 'releaseYearAsc', label: 'Oldest Release' },
