...
export const DISCIPLINE_OPTIONS = [
  ...
  { id: 'park', label: 'Park' },
  { id: 'mini-ramp', label: 'Mini ramp' },
  { id: 'vert', label: 'Vert' },
  { id: 'dirt', label: 'Dirt' },
  { id: 'slopestyle', label: 'Slopestyle' },
  { id: 'big-air', label: 'Big air' },
  { id: 'superpipe', label: 'Superpipe' },
  { id: 'backcountry', label: 'Backcountry / freeride' },
];

export function formatDiscipline(value) {
  return (
    DISCIPLINE_OPTIONS.find((option) => option.id === value)?.label ||
