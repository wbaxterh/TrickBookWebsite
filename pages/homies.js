    ...
    <div className="flex items-center justify-between p-4 rounded-lg bg-secondary/10 border border-border">
      <div className="flex items-center gap-3">
        <Link
          ...
          className="flex-shrink-0 hover:ring-2 hover:ring-yellow-500 rounded-full transition-all"
        >
    ...
    <>
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="mb-8">
          ...
          <p className="text-muted-foreground">Connect with fellow riders and build your crew</p>
        </div>
        ...
        <Tabs value={activeTab} onValueChange={setActiveTab} className="w-full">
          <TabsList className="grid w-full grid-cols-4 mb-8">
            ...
            >
              ...
              Requests
              {pendingCount > 0 && <Badge className="ml-2 bg-red-500">{pendingCount}</Badge>}
            </TabsTrigger>
          </TabsList>
          ...
          <TabsContent value="my-homies">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Riders you&apos;ve connected with</CardDescription>
              </CardHeader>
              <CardContent>
                {loadingHomies ? (
          ...
          <TabsContent value="messages">
            <Card>
              <CardHeader>
                ...
                <CardDescription>Your conversations with homies</CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <div className="space-y-6">
              ...
              <Card>
                <CardHeader>
                  ...
                  <CardDescription>Riders who want to connect with you</CardDescription>
                </CardHeader>
                <CardContent>
                  {loadingRequests ? (
                    ...
                    <div className="space-y-3">
                      {requests.sent.map((user) => (
                        <UserCard
                          key={user._id}
                          user={user}
                          actions={<Badge variant="secondary">Pending</Badge>}
                        />
                      ))}
                    </div>
                  )}
