...
export default function UploadPost() {
  ...
  const [_videoData, setVideoData] = useState(null);
  ...
  const handleImageUpload = async () => {
    ...
    const uploadResult = await uploadImageToS3(selectedFile, token, (progress) => {
      setUploadProgress(progress);
    });
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            {!selectedFile ? (
              ...
              >
                ...
                <p className="text-lg font-medium text-foreground mb-2">Upload your clip</p>
            ...
            {/* Tricks Tags */}
            <div>
              <label className="block text-sm font-medium text-foreground mb-2">Tag Tricks</label>
            ...
            {uploadStep !== 'idle' && uploadStep !== 'error' && (
              <div className="p-4 bg-secondary rounded-lg space-y-3">
                <div className="flex items-center gap-3">
                  ...
                  <span className="text-sm font-medium text-foreground">{processingStatus}</span>
                </div>
                ...
                {uploadStep === 'done' && (
                  <p className="text-sm text-green-500">Redirecting to feed...</p>
                )}
              </div>
            )}
