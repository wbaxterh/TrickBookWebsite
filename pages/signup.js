    ...
    <div className="flex items-center justify-center gap-2 mb-8">
      {[1, 2, 3, 4].map((s) => (
        <div key={s} className="flex items-center">
          ...
          {s < 4 && <div className={`w-8 h-1 mx-1 ${s < step ? 'bg-yellow-500' : 'bg-muted'}`} />}
        </div>
      ))}
    </div>
  );
  ...
  const renderStep2 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground mt-1">Upload a photo or pick a cool icon</p>
      </div>
      ...
      {/* Upload option */}
      <div className="mb-6">
        <label className="block text-sm font-medium mb-2 text-center">Upload Your Photo</label>
      ...
      {/* Icon options */}
      <div>
        <label className="block text-sm font-medium mb-3 text-center">Or Pick an Icon</label>
          ...
          {DEFAULT_AVATARS.map((avatar) => (
            <button
              ...
              className={`w-14 h-14 rounded-full ${avatar.bg} flex items-center justify-center text-2xl transition-all hover:scale-110 ${
                selectedIcon?.id === avatar.id ? 'ring-4 ring-yellow-500 ring-offset-2' : ''
              }`}
            >
              {avatar.emoji}
            </button>
  ...
  const renderStep3 = () => (
    <div className="space-y-6">
      <div className="text-center mb-6">
        ...
        <p className="text-muted-foreground mt-1">Select all the sports you're into</p>
      </div>
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
        <div>
          ...
          <Input
            ...
            onChange={(e) => setRiderProfile({ ...riderProfile, nickname: e.target.value })}
          />
        </div>
        ...
        <div>
          ...
          <select
            ...
            onChange={(e) => setRiderProfile({ ...riderProfile, riderStyle: e.target.value })}
          >
        ...
        <div>
          ...
          <Input
            ...
            onChange={(e) => setRiderProfile({ ...riderProfile, sickestTrick: e.target.value })}
          />
        </div>
  ...
  return (
    <>
      <Head>
        ...
        <meta
          name="description"
          content="Create your TrickBook account and join the action sports community"
        />
