					...
					<Card className="border-yellow-500/50 bg-yellow-500/5 mb-8">
						<CardContent className="pt-6">
							...
							<p className="text-muted-foreground mb-4">
								TrickBook is a community platform built by skaters, for skaters. These terms are written
								to be fair, transparent, and actually readable (no lawyer-speak). By using TrickBook,
								you agree to these terms. If you don't agree, please don't use our service.
							</p>
							<p className="text-sm text-muted-foreground">
								<strong className="text-foreground">The short version:</strong> Be respectful, create awesome content,
								don't be a jerk, and we'll all have a great time.
							</p>
						</CardContent>
					</Card>
					...
					<div className="space-y-8">
								...
								<div className="space-y-4 text-muted-foreground">
									<div>
										...
										<p className="text-sm mb-2">
											You retain ownership of all content you create and post on TrickBook, including:
										</p>
									...
									<div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
										...
										<p className="text-sm">
											By posting content on TrickBook, you grant us a non-exclusive, royalty-free license to
											display, distribute, and promote your content within the TrickBook platform. This license
											exists solely to operate the service (showing your posts to other users, etc.).
											<strong className="text-foreground"> We will never sell your content or use it for advertising.</strong>
										</p>
									</div>
									...
									<div>
										...
										<p className="text-sm">
											The TrickBook name, logo, and original content (Trickipedia entries, The Couch videos,
											interface design) are owned by TrickBook. You may not copy, modify, or distribute our
								...
								<div className="space-y-4 text-muted-foreground">
									<div className="border-l-2 border-yellow-500 pl-4">
										...
										<p className="text-sm mt-1">
											Share your skating journey with photos, videos, and updates. Posts can be liked
											and commented on by other users. You control who sees your content through your
											privacy settings.
										</p>
									</div>
									...
									<div className="border-l-2 border-yellow-500 pl-4">
										...
										<p className="text-sm mt-1">
											Engage with other skaters by commenting on posts. Comments should be constructive
											and respectful. You can delete your own comments at any time. Post authors can
											also remove comments from their posts.
										</p>
									</div>
									...
									<div className="border-l-2 border-yellow-500 pl-4">
										...
										<p className="text-sm mt-1">
											...
											private between you and the recipient. You can only message users who are
											your homies - this prevents spam and unwanted contact.
										</p>
									</div>
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground">
									<p className="text-sm">
										TrickBook features a community-driven database of skate spots. When submitting or using spot information:
									</p>
									<ul className="space-y-2 text-sm">
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span><strong className="text-foreground">Accuracy:</strong> Provide accurate location and description information</span>
										</li>
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span><strong className="text-foreground">Respect:</strong> Don't submit private property without owner permission</span>
										</li>
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span><strong className="text-foreground">Safety:</strong> Note any safety hazards or access restrictions</span>
										</li>
										<li className="flex items-start gap-2">
											<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
											<span><strong className="text-foreground">Updates:</strong> Report spots that are closed, demolished, or changed</span>
										</li>
									</ul>

									<div className="p-4 rounded-lg bg-muted/50">
										<p className="text-sm">
											<strong className="text-foreground">Disclaimer:</strong> TrickBook provides spot information as a community
											resource. We do not guarantee accuracy, safety, or legal access to any spot. Always skate
											responsibly, respect property, and follow local laws. Skate at your own risk.
										</p>
									</div>
								</div>
							</CardContent>
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground">
									<p className="text-sm">
										The Couch is TrickBook's curated video section featuring skating content. When viewing or interacting with The Couch:
									</p>
									<ul className="space-y-2 text-sm">
										<li>• Videos are provided for entertainment and educational purposes</li>
										<li>• Do not attempt dangerous tricks without proper training and safety equipment</li>
										<li>• Video content is owned by TrickBook or licensed from creators</li>
										<li>• You may not download, redistribute, or re-upload videos without permission</li>
									</ul>
								</div>
							</CardContent>
						</Card>
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground">
									<p className="text-sm">
										Trickipedia is our comprehensive trick database for skateboarding and snowboarding. This educational resource includes:
									</p>
									<ul className="space-y-2 text-sm">
									...
									<p className="text-sm">
										Trickipedia content is provided for educational purposes. Always practice tricks safely,
										wear appropriate protective gear, and progress at your own pace. TrickBook is not
										responsible for injuries resulting from attempting tricks.
									</p>
								</div>
							</CardContent>
						</Card>
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground">
									<p className="text-sm">
										To keep TrickBook a positive community, the following content and behavior are prohibited:
									</p>
							...
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground">
									<div className="p-4 rounded-lg bg-yellow-500/10 border border-yellow-500/20">
										...
										<p className="text-sm">
											Skateboarding and snowboarding are inherently dangerous activities. By using TrickBook,
											you acknowledge that you participate in these activities at your own risk. TrickBook is
											not responsible for any injuries, damages, or losses that occur while skating or
											snowboarding, whether or not influenced by content on our platform.
										</p>
									</div>
									...
									<div>
										...
										<ul className="space-y-2 text-sm">
											...
											<li className="flex items-start gap-2">
												<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
												<span>Progress gradually - master basics before attempting advanced tricks</span>
											</li>
											<li className="flex items-start gap-2">
												<CheckCircle className="h-4 w-4 text-green-500 mt-0.5 flex-shrink-0" />
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground text-sm">
									<p>
										<strong className="text-foreground">Service Availability:</strong> TrickBook is provided "as is" without warranties of any kind.
										We strive for 99.9% uptime but cannot guarantee uninterrupted service. We reserve the right
										to modify or discontinue features at any time.
									</p>

									<p>
										<strong className="text-foreground">User Content:</strong> We do not pre-screen user content. While we moderate for violations,
										we are not responsible for content posted by users. If you encounter inappropriate content,
										please report it.
									</p>

									<p>
										<strong className="text-foreground">Third-Party Links:</strong> TrickBook may contain links to external websites. We are not
										responsible for the content, privacy practices, or availability of third-party sites.
									</p>

									<p>
										<strong className="text-foreground">Accuracy:</strong> While we strive for accuracy in Trickipedia and spot information,
										we cannot guarantee that all information is current or error-free. Use your judgment and
						...
						<Card className="border-border">
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground text-sm">
									<p>
										To the maximum extent permitted by law, TrickBook and its owners, employees, and affiliates
							...
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground text-sm">
									<p>
										...
										United States. Any disputes arising from these terms or your use of TrickBook shall
							...
							<CardContent className="pt-6">
								...
								<div className="space-y-4 text-muted-foreground text-sm">
									...
									<p>
										...
										of the new terms. If you disagree with any changes, please stop using the service
