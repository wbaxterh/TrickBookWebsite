...
export default function TrickListDetail() {
	...
	const handleToggleComplete = async (trick) => {
		...
		try {
			...
			setTricks((prev) =>
				prev.map((t) =>
					t._id === trick._id ? { ...t, checked: newStatus } : t
				)
			);
		} catch (error) {
						...
						<div className="flex items-start justify-between">
							<div>
								...
								<div className="flex items-center gap-4 mt-2">
									...
									<Badge
										variant="secondary"
										className={completedCount === totalCount && totalCount > 0 ? "bg-green-500/20 text-green-500" : ""}
									>
			...
			<Dialog open={addDialogOpen} onOpenChange={setAddDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Add a trick to your list to track your progress.
						</DialogDescription>
					</DialogHeader>
					<div className="space-y-4 py-4">
						<div>
							...
							<Input
								...
								value={newTrick.name}
								onChange={(e) =>
									setNewTrick({ ...newTrick, name: e.target.value })
								}
							/>
						</div>
						<div>
							...
							<Input
								...
								value={newTrick.link}
								onChange={(e) =>
									setNewTrick({ ...newTrick, link: e.target.value })
								}
							/>
						</div>
						<div>
							...
							<textarea
								...
								onChange={(e) =>
									setNewTrick({ ...newTrick, notes: e.target.value })
								}
							/>
						</div>
					</div>
			...
			<Dialog open={deleteDialogOpen} onOpenChange={setDeleteDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Are you sure you want to delete &quot;{trickToDelete?.name}&quot;? This action cannot be undone.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
			...
			<Dialog open={deleteListDialogOpen} onOpenChange={setDeleteListDialogOpen}>
				<DialogContent>
					<DialogHeader>
						...
						<DialogDescription>
							Are you sure you want to delete &quot;{list?.name}&quot;? This will permanently delete the list and all {totalCount} trick{totalCount !== 1 ? "s" : ""} in it. This action cannot be undone.
						</DialogDescription>
					</DialogHeader>
					<DialogFooter>
